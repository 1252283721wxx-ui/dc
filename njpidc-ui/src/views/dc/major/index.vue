<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="${comment}" prop="majorName">
        <el-input
    ...
    <el-table v-loading="loading" :data="majorList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="majorName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="${comment}" prop="majorName">
          <el-input v-model="form.majorName" placeholder="请输入${comment}" />
        </el-form-item>
      </el-form>
...
<script>
import { listMajor, getMajor, delMajor, addMajor, updateMajor } from "@/api/dc/major"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除专业表编号为"' + ids + '"的数据项？').then(function() {
        return delMajor(ids)
      }).then(() => {
        this.getList()
