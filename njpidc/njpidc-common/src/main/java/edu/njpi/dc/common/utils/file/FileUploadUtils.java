package edu.njpi.dc.common.utils.file;
...
import edu.njpi.dc.common.exception.file.FileNameLengthLimitExceededException;
import edu.njpi.dc.common.exception.file.FileSizeLimitExceededException;
import edu.njpi.dc.common.exception.file.InvalidExtensionException;
import edu.njpi.dc.common.utils.DateUtils;
import edu.njpi.dc.common.utils.StringUtils;
import edu.njpi.dc.common.utils.uuid.IdUtils;
import edu.njpi.dc.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = NjpidcConfig.getProfile();
    ...
    {
        int dirLastIndex = NjpidcConfig.getProfile().length() + 1;
